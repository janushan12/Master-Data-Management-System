...
// count tot recs
$countSql = $is_admin
        ? "SELECT COUNT(*) AS total FROM master_categories"
        : "SELECT COUNT(*) AS total FROM master_categories WHERE user_id = $user_id";
...
// Base query
$sql = $is_admin
        ? "SELECT * FROM master_categories WHERE 1"
        : "SELECT * FROM master_categories WHERE user_id = $user_id";
...
<html>
    ...
    <body>
        <div class="sidebar">
            ...
            <a href="../category/list.php" class="active"><i class="bi bi-folder"></i> Categories</a>
